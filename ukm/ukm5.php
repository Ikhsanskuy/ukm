...
<head>
  ...
  <style>
    .banner-image {
      background-image: url('img/rohbud1.jpg');
...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
    <div class="container">
      ...
      <a class="navbar-brand" href="#">UKM Kerohanian Budha (UKM Rohbud)</a>
  ...
  <div class="container my-5 d-grid gap-5">
    <div class="border">
      <h2 class="text-center"> UKM Kerohanian Budha (UKM Rohbud) </h2>
      <p>
