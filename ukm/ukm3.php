...
<head>
  ...
  <style>
    .banner-image {
      background-image: url('img/rohkat1.jpg');
...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark p-md-3">
    <div class="container">
      ...
      <a class="navbar-brand" href="#">UKM Kerohanian Katolik (UKM Rohkat)</a>
  ...
  <div class="container my-5 d-grid gap-5">
    <div class="border">
      <h2 class="text-center"> UKM Kerohanian Katolik (UKM Rohkat) </h2>
      <p>
